$(function(){
    ...
    var c4 =$('div.cntWrap>div.content.cnt04>div.section>div.artView>div.artGroup');
    var c4Btn =$('div.cntWrap>div.content.cnt04>div.section>div.btn');
    var c4p =$('div.cntWrap>div.content.cnt04>div.section>div.bar>div.per');
    ...
    c1Btn.click(function(){
        ...
        var num = c1.find('.article').eq(1).attr('data-su');
    ...
    c2Btn.click(function(){
        ...
        var num = c2.find('.article').next().attr('data-su');
    ...
    c3Btn.click(function(){
        ...
        var num = c3.find('.article').eq(1).attr('data-su');
        c3p.css({width : num*16.66+'%'});

    });


    c4.find('.article:last').prependTo(c4);
    c4.css({marginRight : mv+'%'});
    c4Btn.click(function(){
        c4.stop().animate({
            marginRight : t+'%'
        },1000,function(){
            c4.find('.article:first').appendTo(c4);
            c4.css({marginRight : mv+'%'});
        });
        
        var num = c4.find('.article').eq(1).attr('data-su');
        c4p.css({width : num*16.66+'%'});
